...
You can then use this value to calculate PLC50 with the `plc50()` function. You 
can either supply an NLC50 value directly, or allow the function to look up
the NLC50 for the chemical supplied:
