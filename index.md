...
3.  Calculate the value of P_(abs) for the PAH of interest, using the
    results of the TUV model run:
...
to a standard location (determined by
...
a particular site, you can use the
[`pb_multi()`](https://bcgov.github.io/pahwq/reference/pb_multi.md)
function.

First, you must calculate the absorption with
...
to investigate the sensitivity of a given PAH at a location to light
attenuation (`DOC` or `Kd`) and depth over a set of dates.

There is also a plotting function,
[`plot_sens_kd_depth()`](https://bcgov.github.io/pahwq/reference/plot_sens_kd_depth.md)
to make a static or interactive heat map of the analysis.
...
on a 2-column data.frame. The first column must contain wavelengths and
be called `wl`, and the second column contains irradiance values.
Irradiance values must be in units of `"uW / cm^2 / nm"` (default) or
`"W / m^2 / nm"`.
...
function. You can either supply a narcotic benchmark value directly, or
allow the function to calculate the narcotic benchmark for the chemical
supplied:
...
[CONTRIBUTING](https://bcgov.github.io/pahwq/CONTRIBUTING.md)
guidelines.

Please note that this project is released with a [Contributor Code of
Conduct](https://bcgov.github.io/pahwq/CODE_OF_CONDUCT.md). By
