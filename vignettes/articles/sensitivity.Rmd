...
Finally, calculate PLC50 in 𝝁g/L, supplying the P~abs~ value and NLC50 (𝝁g/L):
...
For Anthracene, the ratio of PLC50:NLC50 approaches 1 when Kd(305) is ~ 250 --- in other words, 
PLC50 is nearly the same as NLC50, indicating that the light is attenuated to such 
an extent that the phototoxicity of Anthracene is not activated at the light levels when Kd(305) >= 250.

According to equation 4-1a in ARIS (2023a): 

Kd(305) = a305[DOC]^b305 + 0.13; a305 = 2.76 and b305 = 1.23

so: 

250 = 2.76[DOC]^1.23 + 0.13

Therefore DOC ~= 40 mg/L when Kd(305) is ~250. This is a significantly higher DOC 
concentration than observed in our three sample lakes, and is in fact outside the
range where the above equation is recommended (it is recommended between 0.2 and 23 mg/L).
