...
ggplot(kd_test_a, aes(x = Kd_ref, y = phototoxic_benchmark)) +
  ...
  labs(
    title = TeX(r"(phototoxic benchmark for Anthracene at 3 sites in B.C. for a range of $k_d(305)$)"),
    x = TeX(r"($k_d(305)$)"),
...
ggplot(kd_test_a, aes(x = Kd_ref, y = p_n_ratio)) +
  ...
  facet_wrap(vars(name), ncol = 1) +
  labs(
    title = TeX(r"(Ratio of phototoxic:narcotic benchmark for Anthracene at 3 sites in B.C. for a range of $k_d(305)$)"),
    x = TeX(r"($k_d(305)$)"),
...
ggplot(kd_test_b, aes(x = Kd_ref, y = phototoxic_benchmark)) +
  ...
  facet_wrap(vars(name), ncol = 1) +
  labs(
    title = TeX(r"(phototoxic benchmark for Benzo\[a\]pyrene at 3 sites in B.C. for a range of $k_d(305)$)"),
    x = TeX(r"($k_d(305)$)"),
    y = "phototoxic benchmark (μg/L)"
  )
...
ggplot(kd_test_b, aes(x = Kd_ref, y = p_n_ratio)) +
  ...
  facet_wrap(vars(name), ncol = 1) +
  labs(
    title = TeX(r"(Ratio of phototoxic:narcotic benchmark for Benzo\[a\]pyrene at 3 sites in B.C. for a range of $k_d(305)$)"),
    x = TeX(r"($k_d(305)$)"),
    y = "Ratio of phototoxic:narcotic benchmark"
  )
```
