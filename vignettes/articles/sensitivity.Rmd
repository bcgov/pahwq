...
water quality guidelines. In this section we will look at the feasibilty of using the absorbance spectra from a methylated PAH's parent compound as a proxy for the specific spectra. We will do this by calculating the PLC50 for various methylated PAHs for which we have absorbance spectra, and comparing these values to those calculated using the absorbance spectra of the parent PAH.
...
9-Methylphenanthrene has higher narcotic toxicity (lower NLC50) than its parent 
Phenanthrene.
...
9-Methylanthracene has higher narcotic toxicity (lower NLC50) than its parent 
Anthracene.
...
conservative PLC50 than if the specific absorption spectra is used. Contrary to that seen in the other PAHs above, this effect is still quite pronounced at high
...
9-Methylpyrene has higher narcotic toxicity (lower NLC50) than its parent 
Pyrene.
...
conservative PLC50 than if the specific absorption spectra is used. 
...
intensity/attenuation. At low light attenuation (Kd(305) = 1), the specific spectra gives a more conservative PLC50 for 1-Methylchrysene than that obtained using the 
...
complicated. The difference in the resulting calculated PLC50 is generally not too large, however the magnitude and even the sign of the difference cannot be known. In all cases examined, the narcotic toxicity (NLC50) of the methylated compounds was higher than that of the parent compounds, however the final phototoxicity depended on the differences in the absorption spectra and, in some cases, the level of light attenuation.
