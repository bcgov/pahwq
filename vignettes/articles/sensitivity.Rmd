...
Absorption spectra for all methylated PAHs are not available. In this section we will look at the feasibilty of using the absorbance spectra from a methylated PAH's parent compound as a proxy for the specific spectra. We will do this by calculating the PLC50 for various methylated PAHs for which we have absorbance spectra, and comparing these values to those calculated using the parent PAH absorbance spectra.
...
complicated. The difference in the resulting calculated PLC50 is generally not too large, however the magnitude and even the sign of the difference cannot be known. In all cases examined, the narcotic toxicity (NLC50) of the methylated compounds was higher than that of the parent compounds, however the final phototoxicity depended on the differences in the absorption spectra and the level of light attenuation.
