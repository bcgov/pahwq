...
#' 926-937.
#'
#' @format ## `molar_absorption` A data frame with 132 rows and 11 columns:
#'     One column for `wavelength` (nm), and a column for each PAH, with values of
#'     molar absorption values at each wavelength. Units are (L/mol/cm).
